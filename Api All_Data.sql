...
drop table Ecom_Brands
Select * into Ecom_Brands from Ecom_Brands_bak

drop table Ecom_Banners
Select * into Ecom_Banners from Ecom_Banners_bak

Drop Table Ecom_Products
Select *  into Ecom_Products from Ecom_Products_bak 

Drop Table Ecom_Offers
Select * into Ecom_Offers from Ecom_Offers_bak

Drop Table Ecom_Orders
Select * into Ecom_Orders from Ecom_Orders_bak
...
--drop table Ecom_Brands
--drop table Ecom_Banners
--drop table Ecom_Tasks

--drop table Ecom_Products

--Select * into Ecom_Products_bak from Ecom_Products


-- Select * from Ecom_Products_bak 
--Select Brand, Category, PName from Ecom_Products 
--Order By Brand